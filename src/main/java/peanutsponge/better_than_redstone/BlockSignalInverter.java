...
public class BlockSignalInverter extends BlockDirectional {
	...
	public void updateTick(World world, int x, int y, int z, Random rand) {
		...
		int signalGot = getInvertedCurrent(world, x, y, z);
	...
	public static int getInvertedCurrent(World world, int x, int y, int z){
		int maxCurrent = Math.max(getSideCurrent(world, x, y, z), getInputCurrent(world, x, y, z));
		return (15 - maxCurrent) % 16;
	}
}
